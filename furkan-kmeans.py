...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar  9 12:20:16 2020
...
#%%
plt.scatter(X[y_means == 0,0], X[y_means == 0,1], s = 100, c = "red", label = "Carefull")
...
plt.scatter(X[y_means == 3,0], X[y_means == 3,1], s = 100, c = "yellow", label = "Careless")
